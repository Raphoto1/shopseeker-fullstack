          ...
          <div>
            <form id='registerForm' onSubmit={handleSubmit} className='block-inline'>
              <div className='baseData pb-2'>
                ...
                <input type='text' name='first_name' id='first_name' placeholder='Your artistic name also works' className="input input-sm input-bordered max-w-xs w-full rounded-lg px-1 py-2"/>
              </div>
              <div className="pb-2">
              ...
              <div className="pb-2">
                ...
                <input type='password' name='password' id='password' onChange={e=>setpass(e.target.value)} required className="input input-sm input-bordered max-w-xs w-full rounded-lg px-1 py-2"/>
              </div>
              <div className="pb-2">
                <label htmlFor='confirmPassword'>Confirm Password</label>
                <input type='password' name='confirmPassword' id='confirmPassword' onChange={e=>setPassConf(e.target.value)} required className="input input-sm input-bordered max-w-xs w-full rounded-lg px-1 py-2"/>
              </div>
